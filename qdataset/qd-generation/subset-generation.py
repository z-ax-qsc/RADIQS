...
data_folder = 'qdataset/qd-generation/'

# Load the original dataset
df = pd.read_csv(data_folder + "qdataset_indep_5-100q.csv")
...
num_subsets = 1  # Number of subsets to create
num_circuits = 10  # Number of circuits in each subset
average_depth = (
...
final_df.to_csv(
    data_folder + "/new/synds_" + str(num_subsets) + "_sub_" + str(num_circuits) + ".csv",
    index=False,
)
