    ...
    def load_data_pd(self, filename):
        ...
        for index, row in self.df.iterrows():
            ...
            formatted_data = {
                ...
                "ibmq133": {
                    "width": int(row["ibmq133_width"]),
                    "depth": int(row["ibmq133_depth"]),
                    "gates": row["ibmq133_gates"],
                },
                "ibmq156": {
                    "width": int(row["ibmq156_width"]),
                    "depth": int(row["ibmq156_depth"]),
                    "gates": row["ibmq156_gates"],
                },
